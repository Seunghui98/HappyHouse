...
<body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#portfolio" style="font-family: SUIT-Medium;">공지사항</a></li> 
	 ...
	 <div class="content">
    <div class="wrapper">
      <header style="font-family: SUIT-Medium;">로그인</header>
      <form method="post" action="" id="loginform">
        ...
        <div class="pass-txt"><a href="${root }/user?act=mvfindpass" style="font-family: SUIT-Medium;"></a></div>
        <input id="loginBtn" type="submit" value="Login">
      </form>
      <div class="sign-txt" style="font-family: SUIT-Medium;">아직 회원이 아닌가요? <a href="${root }/user?act=mvsignup" style="font-family: SUIT-Medium;">회원가입</a></div>
    </div>
  </div>
