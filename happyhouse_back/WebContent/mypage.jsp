        ...
        $(document).ready(function () {
            $("#deleteBtn").click(function () {
                if (confirm("정말로 삭제하시겠습니까?")){
                	location.href='${root}/user?act=delete&id=${userInfo.id}';
                }
            });
            
            $("#updateBtn").click(function () {
                location.href='${root}/user?act=mvupdate&id=${userInfo.id}';
            });
        });
...
<body>
        ...
        <div class="wrapper">
            ...
            <header>회원 정보 확인</header>
            <div class="table-wrapper" style="font-family: SUIT-Medium;">
                <div class="header-item border-end">아이디</div>
            	<div class="description-item " >${userInfo.id }</div>
                <div class="header-item border-end">비밀번호</div>
                <div class="description-item">${userInfo.password }</div>
                <div class="header-item border-end">이름</div>
                <div class="description-item">${userInfo.name }</div>
                <div class="header-item border-end">주소</div>
                <div class="description-item">${userInfo.address }</div>
                <div class="header-item border-end">전화번호</div>
                <div class="description-item">${userInfo.phoneNumber }</div>
            </div>
            <div class="btn" style="font-family: SUIT-Medium;">
                <button class="btn btn-dark " type="button" name="mvupdate" id="updateBtn">수정</button>
                <button class="btn btn-dark" type="button" name="delete" id="deleteBtn">회원탈퇴</button>
            </div>
        </div>
    </div>
