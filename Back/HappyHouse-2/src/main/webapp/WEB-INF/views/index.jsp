...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand" href="${root }/#page-top">Happy House</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                        <li class="nav-item"><a class="nav-link" href="${root }/" style="font-family: SUIT-Medium;">Home</a></li>
                        <c:if test="${!empty userInfo }">
                        <li class="nav-item"><a class="nav-link" href="${root }/notice" style="font-family: SUIT-Medium;">공지사항</a></li> 
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="${root }/list" style="font-family: SUIT-Medium;">거래 둘러보기</a>
            </div>
        </header>
